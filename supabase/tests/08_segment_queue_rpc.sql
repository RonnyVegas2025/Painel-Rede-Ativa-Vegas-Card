...
values ('eeeeeeee-0000-4000-8000-000000000009',
        ...
        'authenticated', 'authenticated', 'operador@vegas.local',
...
insert into public.segments (id, source_name, normalized_name, category) values
  ('dddddddd-0000-4000-8000-00000000000a', 'Comercio varejista de produtos farmaceutico', 'Comercio varejista de produtos farmaceutico', 'outros'),
  ('dddddddd-0000-4000-8000-00000000000b', 'Comercio Verejista - Supermercados',          'Comercio Verejista - Supermercados',          'outros'),
  ('dddddddd-0000-4000-8000-00000000000c', 'Padaria e Confeitaria',                       'Padaria e Confeitaria',                       'outros');
...
select is(
  ...
  'Comercio varejista de produtos farmaceutico',
...
values ('dddddddd-0000-4000-8000-00000000000d', 'Comercio varejista de carnes e pescados', 'Carnes', 'outros');
